...
public class roadSituation {
    ...
    roadSituation(boolean EV_EW, boolean EV_NS, double D_EW, double D_NS) {
        east_westLane = EV_EW;
    ...
    // public int densityMode_col(double Last30DaysDensity_EW, double
    // Last30DaysDensity_NS){ //密度模板 0: 低 1:正常 2:高
